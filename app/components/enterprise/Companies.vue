<template>
	<section ref="$section" class="enterprise-companies">
		<div class="layout-grid">
			<div class="enterprise-companies__content">
				<ui-text-block :block="block">
					<nuxt-img src="/images/v-hand.svg" alt="V-Hand Icon" />
				</ui-text-block>
			</div>
			<div>
				<div class="enterprise-companies__logos">
...
const block = {
	title: 'Companies trusting use with our infrastructure',
	description:
